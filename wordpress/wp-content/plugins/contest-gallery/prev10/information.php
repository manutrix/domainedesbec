...
if(empty($optionsSQL)){
    ...
    if(empty($optionsSQL->Version) OR intval($optionsSQL->Version)<10){
        echo "<p style='text-align:center;font-weight:bold;'>You are using a gallery with old engine.<br>Please copy this gallery to use new engine and full Contest Gallery abilities.</p>";
    }else{
        echo "<p style='text-align:center;font-weight:bold;'>$usedShortcode shortcode information:
