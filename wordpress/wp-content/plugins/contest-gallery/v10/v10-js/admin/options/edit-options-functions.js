...
cgJsClassAdmin.options.functions = {
    ...
    loadOptionsArea: function ($,$formLinkObject,$response) {
      ...
      //  setTimeout(function () {// timeout because of 500 options load
            if(location.hash=='#cgTranslationOtherHashLink' || location.search.indexOf('cgTranslationOtherHashLink') >= 0){
...
//$( "#ScaleSizesGalery" ).attr("disabled",true);
       ...
       // cgJsClassAdmin.options.functions.checkInGalleryUpload($);
        ...
        cgJsClassAdmin.options.functions.cg_user_reocgnising_method_upload($);
...
/*    cg_shortcode_multiple_pics_checkboxes: function ($) {
    ...
    cg_FbLikeOnlyShare: function ($,$element) {

        if($("#FbLikeNoShare").prop( "checked" ) && $element.prop('checked')){

            $("#FbLikeNoShare").prop("checked",false);
            $("#FbLikeNoShareContainer").find('.cg_view_option_checkbox').addClass('cg_view_option_unchecked').removeClass('cg_view_option_checked');
...
/*    checkInGalleryUpload: function ($) {
    ...
    cg_inform_admin_after_upload: function ($) {
        ...
        if($('#InformAdmin').prop("checked")){
            ...
            $( "#cgInformAdminFromContainer" ).removeClass('cg_disabled');
            $( "#cgInformAdminAdminMailContainer" ).removeClass('cg_disabled');
            $( "#cgInformAdminReplyContainer" ).removeClass('cg_disabled');
            $( "#cgInformAdminCCContainer" ).removeClass('cg_disabled');
            $( "#cgInformAdminBCCContainer" ).removeClass('cg_disabled');
            $( "#cgInformAdminHeaderContainer" ).removeClass('cg_disabled');
            $( "#wp-InformAdminText-wrap-Container" ).removeClass('cg_disabled');

        }
        else{

            $( "#cgInformAdminFromContainer" ).addClass('cg_disabled');
            $( "#cgInformAdminAdminMailContainer" ).addClass('cg_disabled');
            $( "#cgInformAdminReplyContainer" ).addClass('cg_disabled');
            $( "#cgInformAdminCCContainer" ).addClass('cg_disabled');
            $( "#cgInformAdminBCCContainer" ).addClass('cg_disabled');
            $( "#cgInformAdminHeaderContainer" ).addClass('cg_disabled');
            $( "#wp-InformAdminText-wrap-Container" ).addClass('cg_disabled');
    ...
    cg_image_activation_email: function ($) {
        ...
        if($("#InformUsers").prop("checked")){
            ...
            $( "#InformUsersAdminContainer" ).removeClass("cg_disabled");
            $( "#InformUsersHeaderContainer" ).removeClass("cg_disabled");
            $( "#InformUsersReplyContainer" ).removeClass("cg_disabled");
            $( "#InformUsersCCContainer" ).removeClass("cg_disabled");
            $( "#InformUsersBCCContainer" ).removeClass("cg_disabled");
            $( "#InformUsersURLContainer" ).removeClass("cg_disabled");
            $( "#wp-InformUsersContent-wrap-Container" ).removeClass("cg_disabled");

        } else{

            $( "#InformUsersAdminContainer" ).addClass("cg_disabled");
            $( "#InformUsersHeaderContainer" ).addClass("cg_disabled");
            $( "#InformUsersReplyContainer" ).addClass("cg_disabled");
            $( "#InformUsersCCContainer" ).addClass("cg_disabled");
            $( "#InformUsersBCCContainer" ).addClass("cg_disabled");
            $( "#InformUsersURLContainer" ).addClass("cg_disabled");
            $( "#wp-InformUsersContent-wrap-Container" ).addClass("cg_disabled");
    ...
    cgRegUserGalleryOnly: function ($) {
        ...
        if($('#RegUserGalleryOnly').prop("checked")){

            $( "#wp-RegUserGalleryOnlyText-wrap-Container" ).removeClass("cg_disabled");

        }
        else{

            $( "#wp-RegUserGalleryOnlyText-wrap-Container" ).addClass("cg_disabled");
    ...
    cg_user_reocgnising_method_upload: function ($,$CheckMethodUpload) {
