...
$ratingFileData = cg_check_and_repair_image_file_data($galeryID,$pictureID,$ratingFileData,false);
...
if (($rateValue>5 or $rateValue<1) or ($galleryHash != $galleryHashToCompare)){
    ...
    if (!empty($getRatingPicture) and $IpBlock==1){
        ...
        <script data-cg-processing="true">
            ...
            cgJsClass.gallery.rating.setRatingOneStar(pictureID,0,false,gid,true,false,ratingFileData);
