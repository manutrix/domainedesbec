...
if(!empty($jsonOptions[$galeryNR.'-u']['visual']['AllowSortOptions'])){
    $AllowSortOptionsArrayCgGalleryUser = explode(',',$jsonOptions[$galeryNR.'-u']['visual']['AllowSortOptions']);
}else{
                ...
                <div class='cg_view_options_row'>
                    ...
                    <div class='cg_view_option cg_view_option_50_percent cg_border_top_none DistancePicsVContainer'>
                        <div class='cg_view_option_title'>
                         ...
                         <div  class='cg_view_option_input'>
                            <input type="text" maxlength="2" name="DistancePicsV" class="multiple-pics[cg_gallery_user][general][DistancePicsV]" value="{$jsonOptions[$GalleryID.'-u']['general']['DistancePicsV']}">
                         </div>
                    </div>
                </div>
        </div>
