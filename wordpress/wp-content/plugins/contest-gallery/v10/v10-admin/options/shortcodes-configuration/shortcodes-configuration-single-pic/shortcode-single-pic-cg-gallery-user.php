                    ...
                    <div class='cg_view_option cg_view_option_full_width cg_border_top_none'>
                        ...
                        <div class='cg_view_option_radio_multiple'>
                            <div class='cg_view_option_radio_multiple_container GalleryStyleCenterWhiteContainer'>
                                ...
                                <div class='cg_view_option_radio_multiple_input'>
                                     <input type="radio" name="multiple-pics[cg_gallery_user][visual][GalleryStyle]" class="GalleryStyle cg_view_option_radio_multiple_input_field"  $GalleryStyleCenterWhiteChecked  value="center-white" />
                                </div>
                            </div>
                            <div class='cg_view_option_radio_multiple_container GalleryStyleCenterBlackContainer'>
                                ...
                                <div class='cg_view_option_radio_multiple_input'>
                                    <input type="radio" name="multiple-pics[cg_gallery_user][visual][GalleryStyle]" class="GalleryStyle cg_view_option_radio_multiple_input_field"  $GalleryStyleCenterBlackChecked  value="center-black" >
                                </div>
                            </div>
                    </div>
                </div>
...
echo <<<HEREDOC
                ...
                <div class='cg_view_option cg_border_top_none ImageViewFullWindowContainer'>
                    ...
                    <div class='cg_view_option_checkbox'>
                        <input type="checkbox" name="multiple-pics[cg_gallery_user][visual][ImageViewFullWindow]" checked="{$jsonOptions[$GalleryID.'-u']['visual']['ImageViewFullWindow']}" class="cg_shortcode_checkbox ImageViewFullWindow">
                    </div>
                </div>
            </div>
            ...
            <div class='cg_view_options_row'>
                <div class='cg_view_option cg_border_top_right_none ImageViewFullScreenContainer'>
                    ...
                    <div class='cg_view_option_checkbox'>
                        <input type="checkbox" name="multiple-pics[cg_gallery_user][visual][ImageViewFullScreen]" checked="{$jsonOptions[$GalleryID.'-u']['visual']['ImageViewFullScreen']}" class="cg_shortcode_checkbox ImageViewFullScreen">
                    </div>
                </div>
