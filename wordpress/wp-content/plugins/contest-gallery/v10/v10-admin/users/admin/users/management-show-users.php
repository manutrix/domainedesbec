...
echo "<form id='cgUsersManagementForm' style='font-size: 16px;display:inline;' method='POST' action='?page=".cg_get_version()."/index.php&users_management=true&option_id=$GalleryID#cg-search-results-container' class='cg_load_backend_submit'>";
