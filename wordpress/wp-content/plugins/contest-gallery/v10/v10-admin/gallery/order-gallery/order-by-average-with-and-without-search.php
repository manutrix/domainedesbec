...
if($search===''){
    ...
    /*var_dump("SELECT wp_contest_gal1ery.*,
                        (
                   CASE WHEN NOT EXISTS(SELECT NULL FROM wp_contest_gal1ery_entries WHERE wp_contest_gal1ery.id = wp_contest_gal1ery_entries.pid)
                      THEN 1
                      ELSE 0
                   END
                  ) AS Short_Text
      FROM wp_contest_gal1ery, wp_contest_gal1ery_entries
            WHERE wp_contest_gal1ery.GalleryID = 218
        AND wp_contest_gal1ery_entries.GalleryID = 218
        AND wp_contest_gal1ery.id = wp_contest_gal1ery_entries.pid
      UNION");*/
