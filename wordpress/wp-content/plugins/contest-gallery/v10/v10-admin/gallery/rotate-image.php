...
echo "<form action='?page=".cg_get_version()."/index.php&option_id=$GalleryID&edit_gallery=true' method='POST' class='cg_load_backend_submit'>";
...
echo "<p style='margin-top: 5px;margin-bottom:15px;' ><b>NOTE:</b> Image rotation is CSS based. The original image source will be not rotated.</p>";
