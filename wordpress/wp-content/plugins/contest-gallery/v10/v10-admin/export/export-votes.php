...
if(!function_exists('cg_votes_csv_export')){
    ...
    function cg_votes_csv_export(){
        ...
        $votingData = $wpdb->get_results( "SELECT id, VoteDate, IP, Rating, RatingS, WpUserId, OptionSet, CookieId, Category,CategoriesOn FROM $tablename_ip WHERE pid = '$imageId' ORDER BY id DESC");
