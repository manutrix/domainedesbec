...
wp_enqueue_style( 'cg_css_general_rotate_image', plugins_url('/v10/v10-css/general/cg_rotate_image.css', __FILE__), false, cg_get_version_for_scripts() );
wp_enqueue_script( 'cg_gallery_admin_events', plugins_url( '/v10/v10-js/admin/gallery/gallery-admin-events.js', __FILE__ ), array('jquery'), cg_get_version_for_scripts() );
...
wp_enqueue_script( 'define_output', plugins_url( '/v10/v10-js/admin/define_output.js', __FILE__ ), array('jquery'), cg_get_version_for_scripts() );


//wp_enqueue_script( 'change_text_inform_user', plugins_url( '/v10/v10-js/change_text_inform_user.js', __FILE__ ), array('jquery'), cg_get_version_for_scripts() );
