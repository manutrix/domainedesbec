...
if(!function_exists('cg_json_upload_form_info_data_files')){
    ...
    function cg_json_upload_form_info_data_files($GalleryID,$idsToCopyStringCollect = null){
        ...
        $singleViewOrderDataJson = $wpdb->get_results("SELECT id, Field_Type, Field_Order, Field_Content FROM $tablename_form_input WHERE (GalleryID = $GalleryID AND Show_Slider = 1 AND Active = 1)$Field1IdGalleryViewToSelect$Field2IdGalleryViewToSelect ORDER BY Field_Order DESC");
