...
<div style="width: 800px">
	...
	<div style="margin-top: 1em; float: right; width: 235px; box-shadow: 0 0 2px #ddd; border-radius: 6px; background-color: #fff; border: solid 1px #ddd; padding: 25px;">
		<div style="text-align: center">
			<a href="https://www.checkfront.com/?src=wp-setup"><img src="//cdn.checkfront.com/wp-content/themes/checkfront-redesign/resources/assets/images/logos/checkfront/Checkfront_Color.png" height="40" alt="Checkfront" /></a><br />
		...
		<br />
		<br />
		<a href="https://twitter.com/Checkfront" style="text-decoration: none; background: url('https://www.checkfront.com/wp-content/themes/checkfront-redesign/resources/assets/images/media/twitter-blue.png') left center no-repeat; background-size: 16px; padding: 5px 5px 5px 20px" target="_blank">Follow us on Twitter</a><br /><br />
		<a href="https://www.checkfront.com/login/?src=wp-setup" style="text-decoration: none; background: url('https://www.checkfront.com/wp-content/themes/checkfront-redesign/resources/assets/images/logos/checkfront/Checkfront_Color-Icon.png') left center no-repeat; background-size: 16px; padding: 5px 5px 5px 20px;" target="_blank">Secure Booking Admin Login</a><br /><br />
		<a href="https://www.checkfront.com/wordpress/?src=wp-setup" style="text-decoration: none; background: url('https://www.checkfront.com/wp-content/themes/checkfront-redesign/resources/assets/images/logos/Wordpress.png') left center no-repeat; background-size: 18px; padding: 5px 5px 5px 20px;" target="_blank">Checkfront Wordpress Setup Guide</a>
	</div>
	<br style="clear: both" />
