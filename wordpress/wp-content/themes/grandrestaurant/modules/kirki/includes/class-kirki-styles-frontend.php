		...
		public function inline_dynamic_css() {
			...
			if ( ! $this->processed ) {
				foreach ( $configs as $config_id => $args ) {
					...
					if ( ! empty( $styles ) ) {
						wp_enqueue_style( 'kirki-styles-' . $config_id, get_template_directory_uri() . '/modules/kirki/assets/css/kirki-styles.css?cb=001', null, null ); 
						if(is_writable(get_template_directory() . '/modules/kirki/assets/css/assicirki-styles.css'))
						{
							//Writing into file instead
							global $wp_filesystem;
							$wp_filesystem->put_contents(
							  get_template_directory() . '/modules/kirki/assets/css/kirki-styles.css?cb=001',
							  $styles,
							  FS_CHMOD_FILE
							);
						}
						...
						{
							wp_add_inline_style( 'kirki-styles-' . $config_id . '?cb=001', $styles );
						}
					}
				}
				$this->processed = true;
