	...
	<div class="ppb_tab">
		...
		<div id="tabs-my-templates">
			...
			<div id="template_save_form">
				...
				<a id="ppb_do_save_template_button" class="button button-primary" href="<?php echo esc_url(admin_url('admin-ajax.php?action=grandrestaurant_ppb_set_template&page_id='.$post->ID)); ?>"><?php esc_html_e('Save', 'photography-translation' ); ?></a>
			...
			?>
					<li id="ppb_my_page_<?php echo esc_attr($key); ?>" data-module="<?php echo esc_attr($key); ?>" data-title="<?php echo esc_attr($my_current_template); ?>" data-key="<?php echo esc_attr($key); ?>">
						...
						<a class="delete_link tooltipster" href="<?php echo esc_url(admin_url('admin-ajax.php?action=grandrestaurant_ppb_remove_template&template_id='.$key)); ?>" title="<?php echo esc_html_e('Remove', 'photography-translation' ); ?>"><i class="fa fa-trash"></i></a>
					</li>
			<?php		
			    	} //End foreach
			    }
