	...
	?>
	    <div class="extend_top_contact_info top_contact_info">
	    	<?php
	    	    ...
	    	    {	
	    	?>
	    	    <span id="top_contact_address"><a href="https://www.google.ca/maps/dir/current location/<?php echo esc_html($tg_menu_contact_address); ?>" target="_blank"><i class="fa fa-map-marker"></i><?php echo esc_html($tg_menu_contact_address); ?></a></span>
	    	<?php
	    	    }
	    	?>
	    	<?php
...
<div class="top_bar <?php if(!empty($pp_page_bg) && !empty($page_menu_transparent)) { ?>hasbg<?php } ?> <?php if(!empty($page_menu_transparent)) { ?>hasbg<?php } ?>">
    ...
    <div id="menu_wrapper">
    	...
    	<?php
    	    ...
    	    $tg_retina_logo = str_replace("http://", "https://", kirki_get_option('tg_retina_logo'));
    		...
    		<div class="logo_align">
	    	    <a id="custom_logo" class="logo_wrapper <?php if(!empty($page_menu_transparent)) { ?>hidden<?php } else { ?>default<?php } ?>" href="<?php echo home_url(); ?>">
					...
					<?php
						...
						{
					?>
	    	    	<img src="<?php echo esc_url($tg_retina_logo); ?>" alt="<?php bloginfo('name'); ?>" width="auto" height="34" style="width:auto;height:34px;"/>
	    	    	<?php 
		    	    	}
		    	    ?>
	    	    </a>
    	...
    	<?php
    	    ...
    	    $tg_retina_transparent_logo = str_replace("http://", "https://", kirki_get_option('tg_retina_transparent_logo'));
    	...
    	<div id="logo_transparent" class="logo_container">
    		<div class="logo_align">
	    	    <a id="custom_logo_transparent" class="logo_wrapper <?php if(empty($page_menu_transparent)) { ?>hidden<?php } else { ?>default<?php } ?>" href="<?php echo home_url(); ?>">
	    	    	...
	    	    	<img src="<?php echo esc_url($tg_retina_transparent_logo); ?>" alt="<?php bloginfo('name'); ?>"/>
	    	    	<?php 
		    	    	}
		    	    ?>
	    	    </a>
