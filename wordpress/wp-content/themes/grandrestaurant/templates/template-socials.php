...
<div class="social_wrapper">
    <ul>
    	<?php
    		$pp_facebook_url = str_replace("http://", "https://", get_option('pp_facebook_url'));
    		
    		if(!empty($pp_facebook_url))
    		{
    	?>
    	<li class="facebook"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> href="<?php echo esc_url("https://facebook.com/domainedesbec"); ?>"><i class="fa fa-facebook"></i></a></li>
    	<?php
    		}
    	?>
    	<?php
    	...
    	?>
    	<?php
    		$pp_youtube_url = str_replace("http://", "https://", get_option('pp_youtube_url'));
        ...
        <?php
        	...
        	{
        ?>
        <li class="instagram"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="Instagram" href="https://instagram.com/<?php echo esc_attr($pp_instagram_username); ?>"><i class="fa fa-instagram"></i></a></li>
        <?php
        	}
        ?>
        <?php
