			...
			<div class="social_wrapper">
			    <ul>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li class="facebook"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> href="<?php echo esc_url("https://www.facebook.com/domainedesbec"); ?>"><i class="fa fa-facebook"></i></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
