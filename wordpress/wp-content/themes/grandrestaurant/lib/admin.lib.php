...
foreach($customizer_styling_arr as $key => $customizer_styling)
{
	...
	$demo_url = '';
	if($customizer_styling['demo'] < 6)
	{
		$demo_url = 'http://themes.themegoods2.com/grandrestaurant'.$customizer_styling['demo'].'/';
	}
	else
	{
		$demo_url = 'http://themes.themegoods2.com/grandrestaurant_demos/demo'.$customizer_styling['demo'].'/';
	}
		    	...
		    	<div class="item_content_wrapper">
		    		<div class="item_content">
		    			<div class="item_thumb">
		    				...
		    				<img src="'.get_template_directory_uri().'/cache/demos/screen'.$customizer_styling['demo'].'.jpg" alt=""/></div>
		    			<div class="item_content">
...
foreach($demo_import_options_arr as $key => $demo_import_option)
{
	...
	$demo_url = '';
	if($demo_import_option['demo'] < 6)
	{
		$demo_url = 'http://themes.themegoods2.com/grandrestaurant'.$demo_import_option['demo'].'/';
	}
	else
	{
		$demo_url = 'http://themes.themegoods2.com/grandrestaurant_demos/demo'.$demo_import_option['demo'].'/';
	}
$demo_import_options_html.= '<li class="'.$last_class.'" data-demo="'.$demo_import_option['demo'].'">
		    	<div class="item_content_wrapper">
		    		<div class="item_content">
		    			<div class="item_thumb">
		    				<a class="preview_wrapper" href="'.esc_url($demo_url).'" target="_blank">Preview</a>
		    				<img src="'.get_template_directory_uri().'/cache/demos/screen'.$demo_import_option['demo'].'.jpg" alt=""/></div>
		    			<div class="item_content">
...
array( "name" => "<h2>Import Styling</h2>",
	"desc" => "",
	"id" => SHORTNAME."_get_styling_button",
	"type" => "html",
	"html" => '<strong>*NOTE:</strong> If you import demo styling. It will overwrite your current customizer settings.<br/><br/><strong>What\'s Included</strong>: customizer settings.<br/><br/>
...
array( "name" => "<h2>Import Demo Content</h2>",
	...
	"type" => "html",
	"html" => '<strong>*NOTE:</strong> If you import demo content. It will overwrite the existing data and settings. It\'s not included revolution slider and widgets settings so you have to configure that settings once it\'s done.<br/><br/><strong>What\'s Included</strong>: posts, pages and custom post type contents, images, videos and theme settings.<br/><br/>'.tg_check_system().'
